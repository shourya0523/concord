  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-[15px] text-muted-foreground">
            ...
            your weak topics overlaid on heat; every cell keeps its numeric intensity and sample
            count visible.
          </p>
        </div>
        <Link href="/prep/rag">
      ...
      <WarrenCallout mood="thinking">
        Compare mode lines the same topics up across your target firms. Shared heat is where one
        drill covers several interviews; firm-unique heat is where a single firm over-indexes and
        deserves its own session. Add or remove firms and the matrix realigns.
      </WarrenCallout>
