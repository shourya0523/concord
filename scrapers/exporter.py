...
def export_to_json(company: str, headers: list, questions: list) -> None:
    """Export interview questions to a JSON file"""
    filename = f"{company}_questions.json"
    try:
        payload = [
        ...
        raise Exception(f"An error occurred while exporting to JSON: {e}")
